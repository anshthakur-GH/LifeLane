      ...
      <section className="bg-gradient-to-br from-bg-cream to-bg-light py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-6xl font-bold text-header mb-6">
            Convert Your Car Into a<br />
            <span className="text-emergency">Life-Saving Vehicle</span>
          </h1>
          <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto">
            Connect patients with emergency medical transport instantly. Our platform transforms regular vehicles into life-saving ambulances with verified drivers and real-time tracking.
          </p>
          <Link
            to="/request"
