        ...
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link
              to="/"
              className={`${
                isActive('/') ? 'text-primary' : 'text-header hover:text-primary'
            ...
            <Link
              to="/dashboard"
              className={`${
                isActive('/dashboard') ? 'text-primary' : 'text-header hover:text-primary'
              } font-medium transition-colors`}
            >
              Dashboard
            </Link>
          ...
          <div className="md:hidden py-4 border-t">
            <div className="flex flex-col space-y-4">
              ...
              <Link
                to="/dashboard"
                className={`${
                  isActive('/dashboard') ? 'text-primary' : 'text-header'
                } font-medium`}
                onClick={() => setIsMenuOpen(false)}
              >
                Dashboard
